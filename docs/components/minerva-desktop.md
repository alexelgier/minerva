# Minerva Desktop - Detailed Documentation

See [Architecture Documentation](../architecture/minerva-desktop.md) for technical details.

This document provides comprehensive information about the Minerva Desktop application.
