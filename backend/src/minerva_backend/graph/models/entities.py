...
class Person(Entity):
    ...
    type: Literal[EntityType.PERSON] = EntityType.PERSON.value
...
class Emotion(Entity):
    ...
    type: Literal[EntityType.EMOTION] = EntityType.EMOTION.value
...
class Event(Entity):
    ...
    type: Literal[EntityType.EVENT] = EntityType.EVENT.value
...
class Project(Entity):
    ...
    type: Literal[EntityType.PROJECT] = EntityType.PROJECT.value
...
class Consumable(Entity):
    ...
    type: Literal[EntityType.CONSUMABLE] = EntityType.CONSUMABLE.value
